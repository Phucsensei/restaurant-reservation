                ...
                "AuthProvider.useEffect.initAuth": async ()=>{
                    ...
                    if (token) {
                        try {
                            ...
                            const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getCurrentUser();
                            setUser(userData);
                        } catch (error) {
                            // Token không hợp lệ
...
function AuthGuard(param) {
    let { children } = param;
    _s();
    const { user, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$auth$2e$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthGuard.useEffect": ()=>{
            if (!loading) {
                // Nếu đã đăng nhập và đang ở trang login/register -> redirect về home
                if (user && publicPaths.includes(pathname)) {
                    router.replace('/');
                }
                // Nếu chưa đăng nhập và không ở trang public -> redirect về login
                if (!user && !publicPaths.includes(pathname)) {
...
//# sourceMappingURL=_775b8141._.js.map