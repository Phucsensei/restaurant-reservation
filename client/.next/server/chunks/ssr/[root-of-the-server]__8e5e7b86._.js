        ...
        const initAuth = async ()=>{
            ...
            if (token) {
                try {
                    ...
                    const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].getCurrentUser();
                    setUser(userData);
                } catch (error) {
                    // Token không hợp lệ
...
function AuthGuard({ children }) {
    const { user, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$auth$2e$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8e5e7b86._.js.map